...
The major class imbalance in the penalty response will likely cause problems during the regression modeling. The model will likely have high accuracy by simply predicting there will not be a penalty on each play. To remedy this, I attempt to use an random oversampling process called ROSE that will try to balance the three classes during the cross validation procedure. ROSE generate synthetic samples where the response is more balanced to try and train the model in a more robust fashion. 

4. Results & Discussion
-----------------------

In this section I discuss the results from the two regression analyses. I present the result for the player level as well as the aggregated team level to assess both individual player and team effectiveness during punt plays. 

**4.1 Player Level Analysis**

First, I'll discuss results on the individual player level for both RAEPAC and RAPC. Here I assess how each player contributed towards EPA and penalties controlling for all other players that were on the field with them during a stint. Figure 5 shows the top 10 and bottom 10 players for the RAEPAC metric. 

```{r, echo = F, out.height = "60%", fig.cap = "This figure shows the top 10 and bottom 10 players with regard to EPA contribution. The bottom 10 players are those with negative contribution with Arik Armstead being the worst.", fig.pos = "H", fig.show='hold', fig.align='center'}
...
```{r, echo = F, out.height = "60%", fig.cap = "This figure shows the top 20 players in penalty contribution. These players detract from team success as positive contribution means the penalties hurt their team.", fig.pos = "H", fig.show='hold', fig.align='center'}
...
```{r, echo = F, out.height = "60%", fig.cap = "This plot shows the average EPA contribution for each team. Clearly, the Falcons and the Saints are the most effective teams during punt situations, and the Rams are the least.", fig.pos = "H", fig.show='hold', fig.align='center'}
