...
We completed an exploratory data analysis to help us visualize the data frame we will use for the modeling section. Below we see a histogram and a boxplot for the response variable Field position. We find it is approximately normally distributed with mean -40.
